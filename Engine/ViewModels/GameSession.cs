...
namespace Engine.ViewModels
{
    public class GameSession: BaseNotificationClass
    {
        ...
        private void CompleteQuestAtLocation()
        {
            foreach(Quest quest in CurrentLocation.QuestsAvailableHere)
            {
                ...
                if(questToComplete != null)
                {
                    ...
                    {
                        //Remove the quest completion items from the players inventory
        ...
        public void AttackCurrentMonster()
        {
            ...
            int damageToMonster = RandomNumberGenerator.NumberBetween(CurrentWeapon.MinimumDamage, CurrentWeapon.MaximumDammage);
            ...
            else
            {
                ...
                int damageToPlayer = RandomNumberGenerator.NumberBetween(CurrentMonster.MinimumDammage, CurrentMonster.MaximumDammage);
                ...
                // If player is killed, move tehm back to their home.
